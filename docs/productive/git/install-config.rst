...
.. tab:: Windows
    ...
    Verfügung. Er ist in `Git for Windows`_ integriert und wird standardmäßig
    mitinstalliert. Es gibt jedoch auch ein eigenständiges
    Installationsprogramm in `Releases
