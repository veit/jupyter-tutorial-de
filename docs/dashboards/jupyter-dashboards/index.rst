...
<https://jupyter-dashboards-layout.readthedocs.io/en/latest/>`_ ist ein Add-On
für Jupyter-Notebooks, womit Outputs (Text, Plots, Widgets :abbr:`usw. (und so
weiter)`) in einem Gestaltungsraster oder in Berichtform angeordnet werden
können. Sie speichert die Informationen zum Layout direkt im Notebook, sodass
